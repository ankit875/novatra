#[test_only]
module novatra_market::generalized_tests {
    ...
    use novatra_market::generalized::{Self};
    use novatra_market::mock_usdc_fa::{Self};
    ...
    // Setting up markets
    #[test(aptos_framework = @aptos_framework, deployer = @novatra_market, user_1 = @0x1111, user_2 = @0x2222, user_3 = @0x3333 )]
