class Agent {
  ...
  getSystemPrompt = (roundNumber, source, context, period) => {
    return {
      role: "system",
      content: [
        `You are an AI assistant for the Novatra DeFi prediction market. Your role is to help users place bets, propose new outcomes, and provide guidance throughout the prediction round.\n`,
        `Round Details:\n`,
  ...
  getWeightPrompt = (roundNumber, source, context, period) => {
    return {
      role: "system",
      content: [
        `You are an AI agent responsible for assigning probability to prediction market outcomes in the Novatra DeFi system.\n`,
  ...
  getRevealPrompt = (source, context) => {
    return {
      role: "system",
      content: [
        `You are an AI agent responsible for evaluating prediction market outcomes in the Novatra DeFi system.\n`,
