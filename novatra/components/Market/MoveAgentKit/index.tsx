...
const MoveAgentKit = () => {
    ...
    return (
        <>
            ...
            {/* Modern DeFi Dashboard Layout - MoveAgentKit */}
            <div className="max-w-7xl mx-auto p-4 space-y-6">
                
                {/* Alert Banner */}
                <div className="relative bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-purple-500/10 rounded-xl p-4 border border-purple-400/20 backdrop-blur-sm">
